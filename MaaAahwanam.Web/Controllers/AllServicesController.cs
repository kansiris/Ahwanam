...
namespace MaaAahwanam.Web.Controllers
{
    public class AllServicesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            List<GetProducts_Result> Productlist_InvitationCard = productService.GetProducts_Results("InvitationCard", 0);
            List<GetProducts_Result> Productlist_Gift = productService.GetProducts_Results("Gift", 0);
            List<GetProducts_Result> Productlist_Entertainment = productService.GetProducts_Results("Entertainment", 0);
            ...
            List<GetProducts_Result> Productlist_Other = productService.GetProducts_Results("Other", 0);
