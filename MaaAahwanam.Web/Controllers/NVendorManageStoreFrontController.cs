    ...
    public class NVendorManageStoreFrontController : Controller
    {
        ...
        public void UpdateAmenities(string category, string subcategory, string selectedamenities,string id,string vid)
        {
            ...
            if (category == "Venue")
            {
                ...
                if (selectedamenitieslist.Contains("Sufficient Washroom")) vendorVenue.Sufficient_Washroom = "Yes";
                if (selectedamenitieslist.Contains("Sufficient Room Size")) vendorVenue.Sufficient_Room_Size = "Yes";
                if (selectedamenitieslist.Contains("Intercom")) vendorVenue.Intercom = "Yes";
                if (selectedamenitieslist.Contains("Single Bed")) vendorVenue.Single_Bed = "Yes";
                if (selectedamenitieslist.Contains("Queen Bed")) vendorVenue.Queen_Bed = "Yes";
                if (selectedamenitieslist.Contains("King Bed")) vendorVenue.King_Bed = "Yes";
                if (selectedamenitieslist.Contains("Balcony")) vendorVenue.Balcony = "Yes";
                if (selectedamenitieslist.Contains("Full Length Mirrror")) vendorVenue.Full_Length_Mirrror = "Yes";
                if (selectedamenitieslist.Contains("Jacuzzi")) vendorVenue.Jacuzzi = "Yes";
                if (selectedamenitieslist.Contains("Sofa Set")) vendorVenue.Sofa_Set = "Yes";
                if (selectedamenitieslist.Contains("Coffee Tea Maker")) vendorVenue.Coffee_Tea_Maker = "Yes";
                ...
                if (selectedamenitieslist.Contains("Bath Tub")) vendorVenue.Bath_Tub = "Yes";
                if (selectedamenitieslist.Contains("Electricity")) vendorVenue.Electricity = "Yes";
                if (selectedamenitieslist.Contains("Wellness Center")) vendorVenue.Wellness_Center = "Yes";
                if (selectedamenitieslist.Contains("Spa")) vendorVenue.Spa = "Yes";
                if (selectedamenitieslist.Contains("HDTV")) vendorVenue.HDTV = "Yes";
                if (selectedamenitieslist.Contains("Pet Friendly")) vendorVenue.Pet_Friendly = "Yes";
                if (selectedamenitieslist.Contains("Gym")) vendorVenue.Gym = "Yes";
                if (selectedamenitieslist.Contains("In-house Restaurant")) vendorVenue.In_house_Restaurant = "Yes";
                if (selectedamenitieslist.Contains("Hair Dryer")) vendorVenue.Hair_Dryer= "Yes";

                if (selectedamenitieslist.Contains("Mini Fridge")) vendorVenue.Mini_Fridge = "Yes";
                if (selectedamenitieslist.Contains("In-Room Safe")) vendorVenue.In_Room_Safe = "Yes";
                if (selectedamenitieslist.Contains("Room Heater")) vendorVenue.Room_Heater = "Yes";
                if (selectedamenitieslist.Contains("Wheelchair Accessible")) vendorVenue.Wheelchair_Accessible = "Yes";
                if (selectedamenitieslist.Contains("Power Backup")) vendorVenue.Power_Backup = "Yes";
                if (selectedamenitieslist.Contains("Dining Area")) vendorVenue.Dining_Area = "Yes";
                if (selectedamenitieslist.Contains("Bar")) vendorVenue.Bar = "Yes";
                if (selectedamenitieslist.Contains("Conference Room")) vendorVenue.Conference_Room = "Yes";
                if (selectedamenitieslist.Contains("Swimming Pool")) vendorVenue.Swimming_Pool = "Yes";
                if (selectedamenitieslist.Contains("CCTV Cameras")) vendorVenue.CCTV_Cameras = "Yes";
                if (selectedamenitieslist.Contains("Laundry")) vendorVenue.Laundry = "Yes";
                if (selectedamenitieslist.Contains("Banquet Hall")) vendorVenue.Banquet_Hall = "Yes";
                if (selectedamenitieslist.Contains("Lift/Elevator")) vendorVenue.Lift_or_Elevator = "Yes";
                if (selectedamenitieslist.Contains("Card Payment")) vendorVenue.Card_Payment = "Yes";
                if (selectedamenitieslist.Contains("Parking Facility")) vendorVenue.Parking_Facility = "Yes";
                if (selectedamenitieslist.Contains("Geyser")) vendorVenue.Geyser = "Yes";
                if (selectedamenitieslist.Contains("Complimentary Breakfast")) vendorVenue.Complimentary_Breakfast = "Yes";
